...
<head>
  ...
  <style>
    body {
      ...
      color: #be185d; /* pink untuk unauthorized */
    }
    ...
    .glow {
      color: #be185d;
      text-shadow:
        0 0 10px rgba(190, 24, 93, 0.7),
        0 0 20px rgba(190, 24, 93, 0.6),
        0 0 30px rgba(190, 24, 93, 0.5);
    }
    ...
    main.content {
      position: relative;
      z-index: 10;
      text-shadow: 0 0 3px rgba(190, 24, 93, 0.4);
    }
    a {
  ...
  <script>
    ...
    function createParticle() {
      return {
        ...
        color: `rgba(190, 24, 93, ${Math.random() * 0.5 + 0.3})` // warna pink transparan
      };
    }
