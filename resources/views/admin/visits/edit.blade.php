            ...
            <div class="bg-gradient-to-r from-white to-gray-50 rounded-xl shadow-lg border border-gray-200 p-8 hover:shadow-xl transition-all duration-300">
                <form method="POST" action="{{ route('admin.visits.update', $visit) }}" enctype="multipart/form-data" x-data="visitForm()">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="status" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                                    <option value="pending" {{ old('status', $visit->status) === 'pending' ? 'selected' : '' }}>Menunggu</option>
                                    <option value="konfirmasi" {{ old('status', $visit->status) === 'konfirmasi' ? 'selected' : '' }}>Dikonfirmasi</option>
                                    <option value="selesai" {{ old('status', $visit->status) === 'selesai' ? 'selected' : '' }}>Selesai</option>
                                </select>
                            </div>
                    ...
                    <div class="mt-8 flex items-center justify-end gap-4">
                        <a href="{{ route('admin.visits.show', $visit) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-6 py-2 rounded-lg font-medium transition-colors">
                            Batal
                        </a>
