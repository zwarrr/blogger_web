...
<aside x-data="{ open: false, showLogErrorModal: false, showProfileModal: false, showSettingsModal: false }" class="fixed left-0 top-0 w-64 h-full bg-gradient-to-b from-white to-gray-100 text-gray-800 flex flex-col px-6 py-8 shadow-2xl border-r border-gray-200 z-20 overflow-visible">
  <!-- Logo / Brand -->
